...
# Stacking linear + decision tree + kNN
from sklearn.model_selection import train_test_split
...
#Define the base learners to be used; we used default hyperparameters
estimators = [('LR', LogisticRegression()),
              ('DT', DecisionTreeClassifier()),
              ('kNN', KNeighborsClassifier())]

#Creating a StackingClassifier() classification model object
#Specify the base learners and the combiner model. In this case the latter is a kNN classifier
clf = StackingClassifier(estimators=estimators, final_estimator=KNeighborsClassifier())

model_name = 'kNN Stacking Ensemble of a Decision Tree, a Logistic Regression & a kNN Classifier'
print(model_name)
